		...
		return (
			<>
				<footer className="footer footer-center p-5 bg-primary text-primary-content">
					...
					<div>
						<div className="-mt-4 grid grid-flow-col gap-4 items-center">
							<a
							...
							<a
								href="https://www.producthunt.com/products/formsify"
								target="_blank"
								rel="noreferrer"
							>
								<svg
									...
									viewBox="0 0 32 32"
									xmlns="http://www.w3.org/2000/svg"
									className="fill-primary-content hover:shadow-lg stroke-primary-content stroke-[0.05rem]"
								>
									<title>ProductHunt</title>
									<path d="M 16 3 C 8.832 3 3 8.832 3 16 C 3 23.168 8.832 29 16 29 C 23.168 29 29 23.168 29 16 C 29 8.832 23.168 3 16 3 z M 16 5 C 22.065 5 27 9.935 27 16 C 27 22.065 22.065 27 16 27 C 9.935 27 5 22.065 5 16 C 5 9.935 9.935 5 16 5 z M 13 11 L 13 22 L 15 22 L 15 18 L 17.5 18 C 19.431 18 21 16.431 21 14.5 C 21 12.569 19.431 11 17.5 11 L 13 11 z M 15 13 L 17.5 13 C 18.327 13 19 13.673 19 14.5 C 19 15.327 18.327 16 17.5 16 L 15 16 L 15 13 z" />
								</svg>
							</a>
						</div>
					</div>
